...
import BoxscoreModal from "@/components/client/Boxscore/BoxscoreModal";



async function page({params}){
    const { boxscores } = params;
    const boxscoreLength = boxscores.length;

    switch(boxscoreLength){
        case 3:
            ...
            function DisplayStat({ awayStat, statName, homeStat }) {
              return (
                <div className="flex flex-row justify-center items-center gap-2 py-3 mx-auto">
            ...
            return(
                    <BoxscoreModal>          <div className="text-xs md:text-base text-center text-slate-300  w-11/12 mx-auto">
            ...
            default:
                return(
            <div>(..) intercepted with incorrect params...</div>
                )
    }
}
