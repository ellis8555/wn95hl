      ...
      <div className="flex justify-center my-2">
        <div className="text-slate-300">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-4 w-11/12 m-auto md:w-3/4">
            ...
            <ul>
              <li>Within team game results page now clicking on W, L, T, OTL opens a popup screen. Two ways to close the popover are to either click outside of the popover or clicking or swiping back button</li>
          ...
          <div className="w-11/12 m-auto md:w-3/4">
            <section className="news">
            <h2>General</h2>
            <p className="text-center my-4">** Updated Apr 1, 2024 **</p>
              <ul>
          ...
          <li>Moving forward it's just a matter of adding new features and or stats. There is no shortage of these that have not crossed my mind. Coaches records, playoffs, player stats, upload highlight gifs, etc...</li>
