...
const dbCallFrom = "team/[league]/[season-number]/[team-acronym]/[game-type]";

export default async function({params}){
    const { teamsSegments } = params
    const teamsSegmentsLength = teamsSegments.length;
    ...
    switch(teamsSegmentsLength){
        ...
        default:
            return (
              <div className="mt-4 text-center text-white">Viewing a team requires complete URL</div>
            )
    }
}